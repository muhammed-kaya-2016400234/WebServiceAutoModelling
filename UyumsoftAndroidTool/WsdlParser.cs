...
namespace UyumsoftAndroidTool
{
    class WsdlParser
    {
        ...
        public string webserviceURL = "http://localhost:51725/WebService1.asmx";
        ...
        public WsdlParser() { }
        public WsdlParser(string webserviceURL,string packageName,string destinationPath,string Namespace="www.tempuri.org",bool isDotNet=true,bool debug=true,int timeout=100000)
        {
